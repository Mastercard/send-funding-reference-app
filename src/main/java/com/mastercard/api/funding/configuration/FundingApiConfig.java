package com.mastercard.api.funding.configuration;
...
public class FundingApiConfig {
    ...
    /**
     * Creates an instance of FundingApi using the above defined apiClient
     * @param env Environment from which we pull property details, to pass along to apiClient()
     * @return Instance of FundingApi
     * @throws Exception
     */
    @Bean
    public FundingApi fundingApi(Environment env) throws Exception {
        return new FundingApi(apiClient(env));
    }
